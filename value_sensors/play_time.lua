...
function sensor:settings_gui(player_index)
    ...
    root.add{type="checkbox", name="speedrun_sensor_play_time_checkbox_show_days",
             caption={"sensor.play_time.settings.show_days"},
             state=sensor_settings.show_days}

    root.add{type="checkbox", name="speedrun_sensor_play_time_checkbox_show_seconds",
             caption={"sensor.play_time.settings.show_seconds"},
             state=sensor_settings.show_seconds}

    root.add{type="checkbox", name="speedrun_sensor_play_time_checkbox_show_personal_time",
             caption={"sensor.play_time.settings.show_personal_time"},
             state=sensor_settings.show_personal_time or false}

    root.add{type="button", name="speedrun_sensor_play_time_close", caption={"settings_close"}}
end
