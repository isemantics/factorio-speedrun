...
local function button_graphics(xpos, ypos)
    return {
        ...
        monolith_image = {
            filename = "__speedrun__/graphics/gui.png",
...
default_gui.speedrun_button_with_icon = {
    type = "button_style",
    parent = "slot_button",
...
default_gui.speedrun_expando_closed = {
    type = "button_style",
    parent = "speedrun_button_with_icon",
...
default_gui.speedrun_expando_open = {
    type = "button_style",
    parent = "speedrun_button_with_icon",
...
default_gui.speedrun_cramped_flow_v = {
    type = "vertical_flow_style",
    vertical_spacing = 1,
    horizontal_spacing = 1,
}

default_gui.speedrun_cramped_flow_h = {
